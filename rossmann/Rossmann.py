...
class Rossmann(object):
    ...
    def data_cleaning(self, df1):
        ...
        df1['promo_interval'] = df1['promo_interval'].fillna(0) #df1['promo_interval'].fillna( 0, inplace=True )
    ...
    def feature_engineering(self, df2):
        ...
        df2['week_of_year'] = df2['date'].dt.isocalendar().week.astype( np.int64 ) #  weekofyear foi subtituído por dt.isocalendar().week
    ...
    # Dentro do método data_preparation(self, df5) não deveria ser utilizado o método transform
    # nos scalers ao invés de fit_transform? Se for utilizado o fit_transform os scalers serão 
    # ajustados novamente do 0, perdendo o sentido de carregá-los utilizando a biblioteca pickle.
        ## 5.2. Rescaling
        ...
        # 'promo_time_week'
        df5['promo_time_week'] = self.promo_time_week_scaler.fit_transform(df5[['year']].values)
